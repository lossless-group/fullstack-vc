...
# Structural outline of the source chapter — distinct from `tags` (which are
# marketing hooks). Use these as the in-page TOC when the body is imported.
subsection_outline:
  - "Discussion"
  - "Foundations"
  - "Materials"
...
Team building, composition, and dynamics is paramount in VC. Though there’s been a decade long trend towards VCs that are former founders and entrepreneurs, there’s debate about whether or not the best VCs are even capable of being operators. Data from Endeavor suggests top-tier VC firms are largely composed of partners with operating experience.[^20] Yet, Mike Mortiz, Jim Breyer, Bill Gurley, Peter Fenton, and Fred Wilson were never founders or operators.[^21]

`![][image6]`

Team stability is often cited as hugely important to LPs. Even entrepreneurs are getting wise, with an advice piece in TechCrunch stating “beware the VC that has had any general partners leave the firm.”[^22]

Differentiating among other managers is bound to get more improbable. In the chart below, Samir Kaji tracks the rise of Micro-VCs, and by the end of 2016 he said there were 340 established Micro-VC firms with more than 300 additional firms in market for their first funds.[^23]    
`![][image7]`
...
### Tools of the Trade
* [Bison](https://www.bison.co/) – Intelligence on the PE / VC market, synthesizing unstructured regulatory and news data into actionable information. Particularly helpful for data on:  
  * Fund performance (70% market coverage)   
  * Fundraising (covers 5000+ firm profiles)  
  * LP insights  
* [Pitchbook](https://pitchbook.com/) – Database for PE/VC and M\&A deals, with detailed company profiles. Particularly helpful for:  
  * Sourcing investments   
  * Due diligence   
  * Market news and analysis   
* [Preqin](https://www.preqin.com/) – PE/ VC database, and reports and publications. Particularly helpful for:  
  * Return data   
  * Industry / Sector reports and publications  
  * Active LP profiles   
* [Intralinks](https://www.intralinks.com/) – Virtual dataroom service to allow collaboration across interested parties. Particularly helpful for:  
  * Sharing materials with LPs during due diligence   
  * Building data rooms with pipeline companies   
* [Box](http://www.box.com) – File sharing, storage and collaboration tool. Particularly helpful for:  
  * Well-integrated with other apps such as G Suite, Salesforce, Office etc.   
  * Industry customized solutions 

### Worthwhile Events
* Partner Connect  
* [Trusted Insights](https://www.thetrustedinsight.com/): 150LPs and 30GPs, Trang Nguyen \<trang@thetrustedinsight.com\>  
* SuperReturn and SuperInvestor  
...
#### Think in Grids:
Once you see design in grids, you can’t unsee it. And it opens up a whole new world of design choices. Flip through some books on grids, the most popular being [Making and Breaking the Grid: A Graphic Design Layout Book](https://www.amazon.com/Making-Breaking-Second-Updated-Expanded/dp/163159284X/ref=sr_1_1?ie=UTF8&qid=1529871309&sr=8-1&keywords=making+and+breaking+the+grid), an example of a grid from that book is in the image below:  
`![][image8]`
...
| Adding a New Slide from Template in Google Docs | View Master to Edit the Master Slide |
| :---- | :---- |
| `![][image13]` | `![][image14]`  |
...
[^21]:  Wilson, Fred, “[Investor VCs and Operator VCs](http://avc.com/2017/05/investor-vcs-and-operator-vcs/),” AVC: Blog, May 2017\.

[^22]:  Breeden, Todd, “[What Entrepreneurs Need to Know about Their VCs and How to Identify Red Flags](https://techcrunch.com/2016/02/22/what-entrepreneurs-need-to-know-about-their-vcs-and-how-to-identify-red-flags/),” TechCrunch, February 22, 2016\.

[^23]:  Kaji, Samir, “[So You Want to Start a VC Firm](https://medium.com/vcdium/so-you-want-to-start-a-vc-firm-7f416f3bf4c3),” December 29, 2016\.

[^24]:  Douvos, Chris. “[Deliberate Speed](https://superlp.com/2016/05/25/deliberate-speed/),” SuperLP, Blog, May 25, 2016\.

[^25]:  Shah, Semil. “[How to Transform A VC Fund Capital Base from Individuals to Institutional LPs](http://blog.semilshah.com/2017/10/10/how-to-transform-a-vc-fund-capital-base-from-individuals-to-institutional-lps/),” Blog, October 10, 2017\.
