...
### Tools of the Trade
* “Canned Responses” by Gmail (Walking Ventures) – Allows pre-created responses to specific emails and scenarios you encounter frequently. Here’s [how to set up a ‘canned response’](https://blog.hubspot.com/sales/gmail-templates-canned-responses).  
* [TextExpander](https://textexpander.com/) (Learn Capital) – Allows you to insert snippets of text from pre-created content using a quick search or abbreviation.   
* [SalesforceIQ](https://app.salesforceiq.com/) (Emergence, Monashees) – Connects with your inbox and provides AI-driven suggestions for follow-ups   
* [Grow](https://www.grow.com/) (Emergence) – Provides analytics dashboard, integrating easily and using data collected from various other apps / technologies (Salesforce, Google etc.)  
* [ProsperWorks](https://www.prosperworks.com/) – CRM system that works seamlessly with G-suite  
