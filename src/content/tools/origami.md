...
Two VC-shaped uses beyond the sales pitch: **portfolio support** (hand a portco's ICP to Origami and return a qualified prospect list — a concrete, deliverable favor) and **sourcing** (the same prompt-to-list motion works for finding companies matching a thesis, not just customers matching an ICP).
