...
The chat-embodied Claude — same models as [[tools/claude-code|Claude Code]], different body. Best for quick questions, thinking out loud, connector-based workflows (email, calendar, CRM), and non-technical teammates.

For when to use it vs. Claude Code: [[guides/claude-desktop-vs-claude-code/index|Orientation: Claude Desktop vs Claude Code]].
