...
The "how do you know your agent is any good?" layer. Relevant to Fellows two ways: diligence vocabulary (a serious AI company should have an eval story — asking "what do you use for evals and tracing?" separates shipped products from demos), and as the tool a portco should adopt the week their agent meets real users.
